                ...
                <div className="w-full md:w-5/12 p-8 md:p-14 flex flex-col justify-center bg-white relative z-20">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="password"
                                className="w-full pl-10 pr-10 py-3 bg-white border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#4c6bf4] focus:border-transparent outline-none transition-all text-gray-700 placeholder-gray-400"
